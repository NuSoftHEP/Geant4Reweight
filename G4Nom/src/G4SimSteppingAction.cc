...
*/    
    MyStepTreeBuffer->stepActivePostProcNames->push_back("dummy");
    MyStepTreeBuffer->stepActivePostProcMFPs->push_back(1.);
    MyStepTreeBuffer->stepActivePostProcLens->push_back(1.);
  }
...
*/
    MyStepTreeBuffer->stepActiveAlongProcNames->push_back("dummy");
    MyStepTreeBuffer->stepActiveAlongProcMFPs->push_back(1.);
    MyStepTreeBuffer->stepActiveAlongProcLens->push_back(1.);
  }
