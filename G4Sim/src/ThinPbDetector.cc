...
ThinPbDetector::ThinPbDetector() : G4VUserDetectorConstruction(){ }

ThinPbDetector::~ThinPbDetector() { }

G4VPhysicalVolume * ThinPbDetector::Construct(){
  ...
  G4LogicalVolume * logicDisk = new G4LogicalVolume(solidDisk, lead, "Disk");
