...
w.SetXTitle("Dist to 1st Elastic Scatter (cm)")
w.SetLineColor(2)
w.SetMarkerColor(2)
w.SetMarkerStyle(20)
v.SetLineColor(1)
...
w2.SetTitle("#sigma_{inel}x" + str(sys.argv[5]) + ", #sigma_{el}x" +str(sys.argv[6]))
w2.SetXTitle("Dist to 2nd Elastic Scatter (cm)")
w2.SetLineColor(2)
w2.SetMarkerColor(2)
