...
nom.Draw("(sliceEnergyInelastic - 139.57)>>nd(55,0,1100)")
nom.Draw("(sliceEnergyInelastic - 139.57)>>wd(55,0,1100)", "weight*elastWeight")
var.Draw("(sliceEnergyInelastic - 139.57)>>vd(55,0,1100)")

nom.Draw("(sliceEnergyInelastic - 139.57)>>nn(55,0,1100)", "(sliceIntsInelastic > 0)")
nom.Draw("(sliceEnergyInelastic - 139.57)>>wn(55,0,1100)", "weight*elastWeight*(sliceIntsInelastic > 0)")
var.Draw("(sliceEnergyInelastic - 139.57)>>vn(55,0,1100)", "(sliceIntsInelastic > 0)")
