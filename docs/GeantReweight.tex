...
\subsubsection{Producing Predictions}
...
These are multiplied by the total inelastic cross section to determine the exclusive cross sections. The cascade results and resulting exclusive cross sections are shown in Figure \ref{fig:cascade_xsecs}.
\begin{figure}[htpb]
	\centering
	...
	\end{subfigure}
	\caption{Left: $\pi^+$ -- Carbon Cascade Results, Right: Exclusive Cross Sections}\label{fig:cascade_xsecs}
\end{figure}

\subsection{Doing a Fit}
...
\begin{lstlisting}
  1 #include "sets.fcl"
  2 #include "parameters.fcl"
  3 #include "C$\_$experiments.fcl"
  4 
  5 OutputFile: "C$\_$PiPlus$\_$fit.root"
  6 FitScan: false
  7 Save: false
  8 
  9 Sets: [
...
\begin{lstlisting}
  ...
  6 
  7 
  8   File: "/path/to/C$\_$PiPlus$\_$cross$\_$section.root"
  9 
 10 
 11   FSFile: "/path/to/C$\_$PiPlus$\_$cascade.root"
 12 }
 13 
 14 END$\_$PROLOG
\end{lstlisting}
...
\begin{lstlisting}
 ...
 15 
 16   { 
 17     Name:   "Allarydyce_C_PiPlus"
 18     Graphs: [ ["reac", "C_xsec_reac_piplus"] ]
 19     
 20     Data:   "/path/to/Allarydyce.root"
 21     
 22     Type:   "C_PiPlus"
 23   },
 24 
