...
void G4ReweightParameterMaker::SetNewValsWithElast( const std::vector< std::pair< std::string, double > > & input ,const std::vector< std::pair< std::string, double > > & input_elast ){
