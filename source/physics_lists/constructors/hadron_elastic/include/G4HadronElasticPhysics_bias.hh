...
#ifndef G4HadronElasticPhysics_bias_h
#define G4HadronElasticPhysics_bias_h 1
...
class G4HadronElasticPhysics_bias : public G4VPhysicsConstructor
{
public: 

  G4HadronElasticPhysics_bias(G4int ver = 0, G4double bias = 1.); 

  virtual ~G4HadronElasticPhysics_bias();
...
private:
  ...
  G4HadronElasticPhysics_bias & operator=(const G4HadronElasticPhysics_bias &right);
