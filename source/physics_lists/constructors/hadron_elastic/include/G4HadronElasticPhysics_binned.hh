...
#ifndef G4HadronElasticPhysics_binned_h
#define G4HadronElasticPhysics_binned_h 1
...
class G4HadronElasticPhysics_binned : public G4VPhysicsConstructor
{
public: 

  G4HadronElasticPhysics_binned(G4int ver = 0, G4ReweightHist * bias_hist = NULL); 

  virtual ~G4HadronElasticPhysics_binned();
...
private:
  ...
  G4HadronElasticPhysics_binned & operator=(const G4HadronElasticPhysics_binned &right);
