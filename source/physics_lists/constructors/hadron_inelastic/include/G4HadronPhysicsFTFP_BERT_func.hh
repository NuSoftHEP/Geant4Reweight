...
// ********************************************************************
//
// $Id: G4HadronPhysicsFTFP_BERT_func.hh 101741 2016-11-24 10:45:35Z gcosmo $
//
//---------------------------------------------------------------------------
//
// ClassName:   
...
//----------------------------------------------------------------------------
//
#ifndef G4HadronPhysicsFTFP_BERT_func_h
#define G4HadronPhysicsFTFP_BERT_func_h 1
...
class G4HadronPhysicsFTFP_BERT_func : public G4VPhysicsConstructor
{
  ...
  private:
    ...
    struct ThreadPrivate { 
      ...
      G4BertiniPionBuilder_func * theBertiniPion;
      G4FTFPPionBuilder_func * theFTFPPion;
