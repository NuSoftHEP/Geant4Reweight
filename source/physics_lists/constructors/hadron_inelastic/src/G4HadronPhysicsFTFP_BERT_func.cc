...
// ********************************************************************
//
// $Id: G4HadronPhysicsFTFP_BERT_func.cc 102624 2017-02-10 08:22:14Z gcosmo $
//
//---------------------------------------------------------------------------
//
// ClassName:   
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(G4HadronPhysicsFTFP_BERT_func);
...
void G4HadronPhysicsFTFP_BERT_func::CreateModels()
{
  ...
  tpdata->theFTFPPion=new G4FTFPPionBuilder_func(QuasiElastic,theBias);
  tpdata->thePion->RegisterMe(tpdata->theFTFPPion);
  tpdata->theFTFPPion->SetMinEnergy(minFTFP_pion);
  tpdata->thePion->RegisterMe(tpdata->theBertiniPion=new G4BertiniPionBuilder_func(theBias));
...
G4HadronPhysicsFTFP_BERT_func::~G4HadronPhysicsFTFP_BERT_func()
{
  if (!tpdata) return;
...
void G4HadronPhysicsFTFP_BERT_func::ConstructParticle()
{
...
void G4HadronPhysicsFTFP_BERT_func::ConstructProcess()
{
