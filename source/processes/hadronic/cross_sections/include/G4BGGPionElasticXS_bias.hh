...
#ifndef G4BGGPionElasticXS_bias_h
#define G4BGGPionElasticXS_bias_h
...
class G4BGGPionElasticXS_bias : public G4VCrossSectionDataSet
{
public:

  G4BGGPionElasticXS_bias (const G4ParticleDefinition*, G4double bias=1.);

  virtual ~G4BGGPionElasticXS_bias();
...
private:
  ...
  G4double theBias;
  G4BGGPionElasticXS_bias & operator=(const G4BGGPionElasticXS_bias &right);
  G4BGGPionElasticXS_bias(const G4BGGPionElasticXS_bias&);
