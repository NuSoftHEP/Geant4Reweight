...
#ifndef G4BGGPionElasticXS_binned_h
#define G4BGGPionElasticXS_binned_h
...
class G4BGGPionElasticXS_binned : public G4VCrossSectionDataSet
{
public:

  G4BGGPionElasticXS_binned (const G4ParticleDefinition*, G4ReweightHist * bias_hist);

  virtual ~G4BGGPionElasticXS_binned();
...
private:
  ...
  G4BGGPionElasticXS_binned & operator=(const G4BGGPionElasticXS_binned &right);
  G4BGGPionElasticXS_binned(const G4BGGPionElasticXS_binned&);
