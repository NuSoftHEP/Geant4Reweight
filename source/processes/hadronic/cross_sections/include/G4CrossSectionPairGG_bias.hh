...
//           November 2010
//
#ifndef G4CrossSectionPairGG_bias_h
#define G4CrossSectionPairGG_bias_h
...
class G4CrossSectionPairGG_bias : public G4VCrossSectionDataSet
{
  private:
   G4CrossSectionPairGG_bias();
   G4CrossSectionPairGG_bias(const G4CrossSectionPairGG_bias&);
   G4CrossSectionPairGG_bias& operator=(const G4CrossSectionPairGG_bias&);

  public:
  
  G4CrossSectionPairGG_bias(G4PiNuclearCrossSection_bias * low,
//  	             G4VCrossSectionDataSet * high,
		     G4double Etransit);
  void SetBias(double bias=.1);			      
  virtual ~G4CrossSectionPairGG_bias();
  ...
  private:
    ...
    G4PiNuclearCrossSection_bias * theLowX;   
