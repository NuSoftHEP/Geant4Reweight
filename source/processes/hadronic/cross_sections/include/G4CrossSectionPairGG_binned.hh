...
//           November 2010
//
#ifndef G4CrossSectionPairGG_binned_h
#define G4CrossSectionPairGG_binned_h
...
class G4CrossSectionPairGG_binned : public G4VCrossSectionDataSet
{
  private:
   G4CrossSectionPairGG_binned();
   G4CrossSectionPairGG_binned(const G4CrossSectionPairGG_binned&);
   G4CrossSectionPairGG_binned& operator=(const G4CrossSectionPairGG_binned&);

  public:
  
  G4CrossSectionPairGG_binned(G4PiNuclearCrossSection_binned * low,
//  	             G4VCrossSectionDataSet * high,
		     G4double Etransit);
  void SetBias(G4ReweightHist * bias_hist);			      
  virtual ~G4CrossSectionPairGG_binned();
  ...
  private:
    ...
    G4PiNuclearCrossSection_binned * theLowX;   
