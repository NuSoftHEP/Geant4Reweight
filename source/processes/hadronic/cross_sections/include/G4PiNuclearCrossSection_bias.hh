...
// ********************************************************************
//
#ifndef G4PiNuclearCrossSection_bias_h
#define G4PiNuclearCrossSection_bias_h
...
class G4PiNuclearCrossSection_bias : public G4VCrossSectionDataSet
{
  public:
  
    G4PiNuclearCrossSection_bias();
    virtual ~G4PiNuclearCrossSection_bias();
    
    static const char* Default_Name() {return "G4PiNuclearCrossSection_bias";}
