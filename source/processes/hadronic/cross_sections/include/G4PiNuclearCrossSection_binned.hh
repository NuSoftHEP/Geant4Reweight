...
// ********************************************************************
//
#ifndef G4PiNuclearCrossSection_binned_h
#define G4PiNuclearCrossSection_binned_h
...
class G4PiNuclearCrossSection_binned : public G4VCrossSectionDataSet
{
  public:
  
    G4PiNuclearCrossSection_binned();
    virtual ~G4PiNuclearCrossSection_binned();
    
    static const char* Default_Name() {return "G4PiNuclearCrossSection_binned";}
