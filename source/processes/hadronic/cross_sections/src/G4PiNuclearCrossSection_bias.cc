...
#include "G4PiNuclearCrossSection_bias.hh"
...
//
G4_DECLARE_XS_FACTORY(G4PiNuclearCrossSection_bias);
...
// 19 Aug 2011, V.Ivanchenko move to new design and make x-section per element
 ...
 const G4double G4PiNuclearCrossSection_bias::he_in[38] =  { 
 ...
 const G4double G4PiNuclearCrossSection_bias::be_m_t[38] = {
 ...
 const G4double G4PiNuclearCrossSection_bias::be_m_in[38] = { 
 ...
 const G4double G4PiNuclearCrossSection_bias::c_m_in[39] = {
 ...
 const G4double G4PiNuclearCrossSection_bias::n_m_in[39] = {
 ...
 const G4double G4PiNuclearCrossSection_bias::e4[32] = {
 ...
 const G4double G4PiNuclearCrossSection_bias::fe_m_t[32] = {
 ...
 const G4double G4PiNuclearCrossSection_bias::fe_m_in[32] = {
 ...
 const G4double G4PiNuclearCrossSection_bias::cu_m_in[32] = {
 ...
 const G4double G4PiNuclearCrossSection_bias::mo_m_t[34] = {
 ...
 const G4double G4PiNuclearCrossSection_bias::mo_m_in[34] = {
 ...
 const G4double G4PiNuclearCrossSection_bias::cd_m_in[34]= {
 ...
 const G4double G4PiNuclearCrossSection_bias::sn_m_in[35] = {
 ...
 const G4double G4PiNuclearCrossSection_bias::sn_p_t[29] = {
 ...
 const G4double G4PiNuclearCrossSection_bias::sn_p_in[29] = {
 ...
 const G4double G4PiNuclearCrossSection_bias::w_m_t[35] = {
 ...
 const G4double G4PiNuclearCrossSection_bias::w_m_in[35] = {
 ...
 const G4double G4PiNuclearCrossSection_bias::w_p_t[30] = {
 ...
 const G4double G4PiNuclearCrossSection_bias::w_p_in[30] = {
 ...
 const G4double G4PiNuclearCrossSection_bias::e7[35] = {
  0.02, 0.04, 0.05, 0.06, 0.07, 0.08, 0.09, 0.10, 0.12, 0.14, 0.16, 0.18,
  0.20, 0.22, 0.25, 0.30, 0.35, 0.40, 0.45, 0.50, 0.55, 0.60, 0.70, 0.80,
  0.90,    1,    2,    3,    5,   10,   20,   50,  100,  500, 100000};

 const G4double G4PiNuclearCrossSection_bias::pb_m_t[35] = {
 ...
 const G4double G4PiNuclearCrossSection_bias::pb_m_in[35] = {
 ...
 const G4double G4PiNuclearCrossSection_bias::pb_p_t[30] = { 
 ...
 const G4double G4PiNuclearCrossSection_bias::pb_p_in[30] = { 
 ...
 const G4double G4PiNuclearCrossSection_bias::u_m_t[35] =   {
 ...
 const G4double G4PiNuclearCrossSection_bias::u_m_in[35] =  {
 ...
 const G4double G4PiNuclearCrossSection_bias::u_p_t[30] =   { 
 ...
 const G4double G4PiNuclearCrossSection_bias::u_p_in[30] =  { 
...
G4PiNuclearCrossSection_bias::G4PiNuclearCrossSection_bias()
 : G4VCrossSectionDataSet(Default_Name()),
   fTotalXsc(0.0), fElasticXsc(0.0), theBias(1.)
{
  SetMinKinEnergy(0.0);
...
void G4PiNuclearCrossSection_bias::SetBias(double bias){
  theBias = bias;
}

G4PiNuclearCrossSection_bias::
~G4PiNuclearCrossSection_bias()
{
...
void
G4PiNuclearCrossSection_bias::CrossSectionDescription(std::ostream& outFile) const
{
  outFile << "G4PiNuclearCrossSection_bias calculates the pion inelastic cross\n"
...
G4bool 
G4PiNuclearCrossSection_bias::IsElementApplicable(const G4DynamicParticle*,
...
void G4PiNuclearCrossSection_bias::BuildPhysicsTable(const G4ParticleDefinition& p)
{
...
G4double 
G4PiNuclearCrossSection_bias::GetElementCrossSection(const G4DynamicParticle* particle, 
						G4int Z, const G4Material*)
{
  ...
  if(Z > theZ[it]) 
  {
    throw G4HadronicException(__FILE__, __LINE__,
      "Called G4PiNuclearCrossSection_bias outside parametrization");
  }
  G4int Z1, Z2;
...
//  G4cout << result << G4endl;
  return theBias*result;
  //return result;
}


G4double G4PiNuclearCrossSection_bias::
