...
//
G4_DECLARE_XS_FACTORY(G4PiNuclearCrossSection_binned);
...
// 19 Aug 2011, V.Ivanchenko move to new design and make x-section per element
 ...
 const G4double G4PiNuclearCrossSection_binned::he_in[38] =  { 
 ...
 const G4double G4PiNuclearCrossSection_binned::be_m_t[38] = {
 ...
 const G4double G4PiNuclearCrossSection_binned::be_m_in[38] = { 
 ...
 const G4double G4PiNuclearCrossSection_binned::c_m_in[39] = {
 ...
 const G4double G4PiNuclearCrossSection_binned::n_m_in[39] = {
 ...
 const G4double G4PiNuclearCrossSection_binned::e4[32] = {
 ...
 const G4double G4PiNuclearCrossSection_binned::fe_m_t[32] = {
 ...
 const G4double G4PiNuclearCrossSection_binned::fe_m_in[32] = {
 ...
 const G4double G4PiNuclearCrossSection_binned::cu_m_in[32] = {
 ...
 const G4double G4PiNuclearCrossSection_binned::mo_m_t[34] = {
 ...
 const G4double G4PiNuclearCrossSection_binned::mo_m_in[34] = {
 ...
 const G4double G4PiNuclearCrossSection_binned::cd_m_in[34]= {
 ...
 const G4double G4PiNuclearCrossSection_binned::sn_m_in[35] = {
 ...
 const G4double G4PiNuclearCrossSection_binned::sn_p_t[29] = {
 ...
 const G4double G4PiNuclearCrossSection_binned::sn_p_in[29] = {
 ...
 const G4double G4PiNuclearCrossSection_binned::w_m_t[35] = {
 ...
 const G4double G4PiNuclearCrossSection_binned::w_m_in[35] = {
 ...
 const G4double G4PiNuclearCrossSection_binned::w_p_t[30] = {
 ...
 const G4double G4PiNuclearCrossSection_binned::w_p_in[30] = {
 ...
 const G4double G4PiNuclearCrossSection_binned::e7[35] = {
  0.02, 0.04, 0.05, 0.06, 0.07, 0.08, 0.09, 0.10, 0.12, 0.14, 0.16, 0.18,
  0.20, 0.22, 0.25, 0.30, 0.35, 0.40, 0.45, 0.50, 0.55, 0.60, 0.70, 0.80,
  0.90,    1,    2,    3,    5,   10,   20,   50,  100,  500, 100000};

 const G4double G4PiNuclearCrossSection_binned::pb_m_t[35] = {
 ...
 const G4double G4PiNuclearCrossSection_binned::pb_m_in[35] = {
 ...
 const G4double G4PiNuclearCrossSection_binned::pb_p_t[30] = { 
 ...
 const G4double G4PiNuclearCrossSection_binned::pb_p_in[30] = { 
 ...
 const G4double G4PiNuclearCrossSection_binned::u_m_t[35] =   {
 ...
 const G4double G4PiNuclearCrossSection_binned::u_m_in[35] =  {
 ...
 const G4double G4PiNuclearCrossSection_binned::u_p_t[30] =   { 
 ...
 const G4double G4PiNuclearCrossSection_binned::u_p_in[30] =  { 
...
G4PiNuclearCrossSection_binned::G4PiNuclearCrossSection_binned()
...
void G4PiNuclearCrossSection_binned::SetBias(G4ReweightHist * bias_hist){
  theBias = bias_hist;
}

G4PiNuclearCrossSection_binned::
~G4PiNuclearCrossSection_binned()
{
...
void
G4PiNuclearCrossSection_binned::CrossSectionDescription(std::ostream& outFile) const
{
  outFile << "G4PiNuclearCrossSection_binned calculates the pion inelastic cross\n"
...
G4bool 
G4PiNuclearCrossSection_binned::IsElementApplicable(const G4DynamicParticle*,
...
void G4PiNuclearCrossSection_binned::BuildPhysicsTable(const G4ParticleDefinition& p)
{
...
G4double 
G4PiNuclearCrossSection_binned::GetElementCrossSection(const G4DynamicParticle* particle, 
						G4int Z, const G4Material*)
{
  ...
  if(Z > theZ[it]) 
  {
    throw G4HadronicException(__FILE__, __LINE__,
      "Called G4PiNuclearCrossSection_binned outside parametrization");
  }
  G4int Z1, Z2;
...
G4double G4PiNuclearCrossSection_binned::
