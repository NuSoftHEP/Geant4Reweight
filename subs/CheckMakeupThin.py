...
for sample in ls(folder):
  ...
  if folder == "nom":
    ...
    print "SAMPLE:", samp
  for outdir in ls("/pnfs/dune/scratch/users/calcuttj/GeantReweight/Thin/"): 
    if outdir in found: continue
#      print outdir
#      print ls("/pnfs/dune/scratch/users/calcuttj/GeantReweight/Thin/" + outdir)[0]
    this_file = ls("/pnfs/dune/scratch/users/calcuttj/GeantReweight/Thin/" + outdir)[0]
    print this_file
